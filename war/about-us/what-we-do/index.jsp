...
<html>
	<head>
		...
		<title>The Five C's - What We Do</title>
		<meta name="description" content="Chernobyl Children Cancer Care Cardiff, The Five Cs. About our work with the Belarusian Children's Hospice in Minsk, Belarus">
		<meta name="robots" content="index,follow">
		<meta name="keywords" content="Five Cs,5Cs,Chernobyl,Children,Cancer,Care,Cardiff,Charity,What,We,Do">
			...
			<div class="container">
				...
				<div class="bigBox first">
					<div class="article-image">
						<img class="article-picture" src="/Images/WhatWeDo.jpg" alt="Picture of the painted camp" />
					</div>
					<p class="block-text">
					...
					<p class="block-text">
						We work closely with the Friends of the Belarusian Children's Hospice (UK). For more information, click 
						<a href="http://www.friends-bch.org.uk/" target="_blank">here</a>.
					</p>
