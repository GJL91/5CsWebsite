...
<html>
	<head>
		...
		<title>The Five C's - 2011 Newsletters</title>
		<meta name="description" content="Chernobyl Children Cancer Care Cardiff, The Five Cs. Catch up with our 2011 newsletters">
		<meta name="robots" content="index,follow">
		<meta name="keywords" content="Five Cs,5Cs,Chernobyl,Children,Cancer,Care,Cardiff,Charity,2011,Newsletters">
	...
	<body>
		...
		<div class="mainContent">
			<div class="container">
				<h1>2011 Newsletters</h1>
				<div class="bigBox first">
					<%
						String path = application.getRealPath("/news/2011/newsletters");
						...
						for (int j = 0; j < newsletters.length; j++) {
							if (!"index.jsp".equals(newsletters[j])) { 
								...
								<div class="newsletter">
									...
									<a class="text-large" href="/news/2011/newsletters/<%= newsletters[j] %>" target="_blank"><span></span><%= parts[1] %></a>
								</div>
					 	<%  } %>
					<%  } %>
				</div>
