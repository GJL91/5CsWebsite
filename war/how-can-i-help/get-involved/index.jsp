...
<html>
	<head>
		...
		<title>The Five C's - Get Involved</title>
		<meta name="description" content="Chernobyl Children Cancer Care Cardiff, The Five Cs. How you can get involved with the charity">
		<meta name="robots" content="index,follow">
		<meta name="keywords" content="Five Cs,5Cs,Chernobyl,Children,Cancer,Care,Cardiff,Charity,Get,Involved">
			...
			<div class="container">
				...
				<div class="bigBox first">
					...
					<p class="block-text">
						...
						<a href="https://mydonate.bt.com/charities/the5cs" target=" _blank">here</a>. 
					</p>
					<p class="block-text">
						To see a list of current and upcoming sponsored events and fundraisers you could take part
