					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
									...
									if (rootFolder != null) {
										...
										for (int i = 0; i < files.length; i++) {
											...
											<li class="dropdown-submenu">
												<a href="/5Cs/news/<%= name %>/events/"><%= name %></a>
												<ul class="dropdown-menu" role="menu">
													<li><a href="/5Cs/news/<%= name %>/events/">Events</a></li>
													<li class="dropdown-submenu">
														<a href="/5Cs/news/<%= name %>/newsletters/">Newsletters</a>
							...
							<li class="dropdown <%= isActive("support", request) %>">
								<a href="/5Cs/support/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Support <span class="caret"></span></a>
								<ul class="dropdown-menu" role="menu">
