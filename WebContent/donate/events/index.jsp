		...
		<div class="mainContent">
			<div class="container">
				...
				<div class="bigBox first">
					<h5>Miss Jones</h5>
					<p class="block-text">
						On 17th November we will be kick starting our fundraising for next year’s Summer Camp with an
						evening at Miss Jones cocktail bar in Whitchurch from 7pm.
					</p>
					<p class="block-text">
						Join us for a 3 course meal and/or drinks while listening to some great entertainment.
					</p>
					<p class="block-text">
						For tickets please <a href="/5Cs/contact-us/">contact us</a>.
					</p>
					
					<h5>Christmas Film Night</h5>
					<p class="block-text">
						On 14th December we will be holding a Christmas Film Night at Whitchurch Community Centre from 6.30 – 9.30
					</p>
					<p class="block-text">
					...
					<p class="block-text">
						If you would like to join us on this fundraising venture please contact us and create a fundraiser
						profile here.
					</p>
					...
					<h5>Hitchhike</h5>
					<p class="block-text">
						We are in the process of organising a group sponsored hitchhike to Belarus with our partner organisation in Germany.
					</p>
					<p class="block-text">
						More news of this will be updated soon.
					</p>
					<p class="block-text">
						To sponsor us on this fundraising venture please click here!
					</p>
					
					<h5>Hamburg 10km Run</h5>
					<p class="block-text">
						On April 26th a team of us here at the Five C’s will be travelling to Hamburg, Germany to join our
						partner organisation in Germany to complete another sponsored 10km run.
					</p>
					<p class="block-text">
						To sponsor us on this fundraiser please click here!
					</p>
					<p class="block-text">
						Or if you’d rather join us on this, please contact us and create a fundraiser profile here.
					</p>
				</div>
			</div>
		</div>
